...
namespace MvvmHelpers
{
	...
	public class WeakEventManager
	{
		...
		{
			if (!_eventHandlers.TryGetValue(eventName, out var targets) || targets is null)
			{
		...
		{
            if (!_eventHandlers.TryGetValue(eventName, out var subscriptions) || subscriptions is null)
                return;
